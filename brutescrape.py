...
if len(sys.argv) > 3 or len(sys.argv) < 2:
    ...
    [*]Ussage:  brutescrape.py [site_list.scrape] 
                brutescrape.py [site_list.scrape] <OPTIONAL> [OutputPassFile.txt] """)
    exit(1)
...
for site in sites:
    try:
        ...
        x = stripHTMLTags(response.read().decode('utf-8'))
...
print ("[*] Output Located: " + f_write.name)
